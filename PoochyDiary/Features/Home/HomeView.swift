...
class HomeView: UIView {
    ...
    private func setupUI() {
        ...
        addDiaryEntryButton.addTarget(
            self, action: #selector(handleAddDiaryEntryButtonTap), for: .touchUpInside)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            stackView.topAnchor.constraint(
                equalTo: scrollView.contentLayoutGuide.topAnchor, constant: Spacing.space24),
            stackView.bottomAnchor.constraint(
                equalTo: scrollView.contentLayoutGuide.bottomAnchor, constant: -Spacing.space32),
            stackView.leadingAnchor.constraint(
                equalTo: scrollView.contentLayoutGuide.leadingAnchor, constant: Spacing.space20),
            stackView.trailingAnchor.constraint(
                equalTo: scrollView.contentLayoutGuide.trailingAnchor, constant: -Spacing.space20),
            stackView.widthAnchor.constraint(
                equalTo: scrollView.frameLayoutGuide.widthAnchor, constant: -Spacing.space40),
            ...
            statusStack.topAnchor.constraint(
                equalTo: statusCard.topAnchor, constant: Spacing.space20),
            statusStack.bottomAnchor.constraint(
                equalTo: statusCard.bottomAnchor, constant: -Spacing.space20),
            statusStack.leadingAnchor.constraint(
                equalTo: statusCard.leadingAnchor, constant: Spacing.space20),
            statusStack.trailingAnchor.constraint(
                equalTo: statusCard.trailingAnchor, constant: -Spacing.space20),
...
private final class HomeMetricView: BaseView {
    ...
    func configure(
        value: String, title: String, caption: String, valueColor: UIColor = PoochyTheme.primaryText
    ) {
...
private final class HomePillView: BaseView {
    ...
    override func constructSubviewLayoutConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -Spacing.space10),
...
private final class HomeKeyValueRowView: BaseView {
    ...
    override func constructSubviewLayoutConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: Spacing.space12),
            stackView.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -Spacing.space12),
...
private final class HomeStatusChipView: BaseView {
    ...
    override func constructSubviewLayoutConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.bottomAnchor.constraint(
                lessThanOrEqualTo: bottomAnchor, constant: -Spacing.space10),
            stackView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: Spacing.space10),
            stackView.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -Spacing.space10),
            imageView.heightAnchor.constraint(equalToConstant: 14),
