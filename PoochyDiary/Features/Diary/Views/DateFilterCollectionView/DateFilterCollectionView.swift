...
class DateFilterCollectionView: BaseView {
    ...
    private typealias DataSource = UICollectionViewDiffableDataSource<Int, DateFilterCollectionViewCell.Model>
    private typealias Snapshot = NSDiffableDataSourceSnapshot<Int, DateFilterCollectionViewCell.Model>
    ...
    override init(frame: CGRect) {
        ...
        collectionView.register(DateFilterCollectionViewCell.self,
        ...
        DataSource(collectionView: collectionView) { collectionView, indexPath, itemIdentifier in
            guard let cell = collectionView
                .dequeueReusableCell(
                    ...
                    for: indexPath) as? DateFilterCollectionViewCell else {
                return nil
            }
...
extension DateFilterCollectionView: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard let snapshot = dataSource?.snapshot(),
              let selectedItem = snapshot.itemIdentifiers[safe: indexPath.item] else { return }
