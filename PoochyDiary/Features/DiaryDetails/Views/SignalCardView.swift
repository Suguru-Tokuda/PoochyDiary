    ...
    override func constructSubviewLayoutConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            iconContainerView.leadingAnchor.constraint(
                equalTo: leadingAnchor, constant: Spacing.space12),
            ...
            titleLabel.topAnchor.constraint(
                greaterThanOrEqualTo: iconContainerView.bottomAnchor, constant: Spacing.space16),

            valueLabel.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor),
            valueLabel.trailingAnchor.constraint(equalTo: titleLabel.trailingAnchor),
            valueLabel.topAnchor.constraint(
                equalTo: titleLabel.bottomAnchor, constant: Spacing.space4),
