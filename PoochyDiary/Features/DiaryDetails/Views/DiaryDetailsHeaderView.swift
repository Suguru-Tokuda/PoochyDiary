...
class DiaryDetailsHeaderView: BaseView {
    struct Model {
        let pet: Pet
        let diary: Diary
    }
    ...
    override func constructSubviewLayoutConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            statusDotView.leadingAnchor.constraint(
                equalTo: statusPillView.leadingAnchor, constant: Spacing.space12),
            statusLabel.centerYAnchor.constraint(equalTo: statusPillView.centerYAnchor),
            statusLabel.leadingAnchor.constraint(
                equalTo: statusDotView.trailingAnchor, constant: Spacing.space4),
            statusLabel.trailingAnchor.constraint(
                equalTo: statusPillView.trailingAnchor, constant: -Spacing.space12),
            ...
            vStack.leadingAnchor.constraint(
                equalTo: imageView.trailingAnchor, constant: Spacing.space16),
