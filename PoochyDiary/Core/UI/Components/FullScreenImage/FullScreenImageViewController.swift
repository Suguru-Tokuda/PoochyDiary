...
class FullScreenImageViewController: BaseViewController {
    ...
    override func constructSubviewLayoutConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            closeButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: Spacing.space12),
            closeButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -Spacing.space16),
...
extension FullScreenImageViewController: ZoomTransitionSupporting {
    ...
    func startItemImageFrame(in targetView: UIView, fallbackImageSize: CGSize? = nil) -> CGRect? {
        fullScreenImageView.startItemImageFrame(in: targetView, fallbackImageSize: fallbackImageSize)
    }
